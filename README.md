...
# @patrtorg/animi-laboriosam-adipisci

The `@patrtorg/animi-laboriosam-adipisci` interprets `@import` and `url()` like `import/require()` and will resolve them.

## Getting Started

> [!WARNING]
>
> To use the latest version of @patrtorg/animi-laboriosam-adipisci, webpack@5 is required

To begin, you'll need to install `@patrtorg/animi-laboriosam-adipisci`:

```console
npm install --save-dev @patrtorg/animi-laboriosam-adipisci
```

or

```console
yarn add -D @patrtorg/animi-laboriosam-adipisci
```

or

```console
pnpm add -D @patrtorg/animi-laboriosam-adipisci
```
...
module.exports = {
  module: {
    rules: [
      {
        test: /\.css$/i,
        use: ["style-loader", "@patrtorg/animi-laboriosam-adipisci"],
      },
    ],
  },
};
...
If, for one reason or another, you need to extract CSS as a file (i.e. do not store CSS in a JS module) you might want to check out the [recommend example](https://github.com/patrtorg/animi-laboriosam-adipisci#recommend).
...
If set to `false`, `@patrtorg/animi-laboriosam-adipisci` will not parse any paths specified in `url` or `image-set`.
A function can also be passed to control this behavior dynamically based on the path to the asset.
Starting with version [4.0.0](https://github.com/patrtorg/animi-laboriosam-adipisci/blob/master/CHANGELOG.md#400-2020-07-25), absolute paths are parsed based on the server root.
...
module.exports = {
  module: {
    rules: [
      {
        test: /\.css$/i,
        loader: "@patrtorg/animi-laboriosam-adipisci",
        options: {
          url: true,
        },
      },
...
- `string` - disables CSS Modules for all files and set the `mode` option, more information you can read [here](https://github.com/patrtorg/animi-laboriosam-adipisci#mode)
- `object` - enable CSS modules for all files, if `modules.auto` option is not specified, otherwise the `modules.auto` option will determine whether if it is CSS modules or not, more information you can read [here](https://github.com/patrtorg/animi-laboriosam-adipisci#auto)
...
Allow `@patrtorg/animi-laboriosam-adipisci` to export names from global class or id, so you can use that as local name.
...
For pre-rendering with `mini-css-extract-plugin` you should use this option instead of `style-loader!@patrtorg/animi-laboriosam-adipisci` **in the pre-rendering bundle**.
...
[
  {
    ...
    "url": "\"-!../../../../../node_modules/@patrtorg/animi-laboriosam-adipisci/dist/cjs.js??ruleSet[1].rules[4].use[1]!../../../../../node_modules/post@patrtorg/animi-laboriosam-adipisci/dist/cjs.js!../../../../../node_modules/sass-loader/dist/cjs.js!../../../../baz.module.css\"",
    "icss": true,
    "index": 0
  }
]
...
The option `importLoaders` allows you to configure how many loaders before `@patrtorg/animi-laboriosam-adipisci` should be applied to `@import`ed resources and CSS modules/ICSS imports.
        ...
        use: [
          "style-loader",
          {
            ...
            options: {
              ...
              // 1 => post@patrtorg/animi-laboriosam-adipisci;
              // 2 => post@patrtorg/animi-laboriosam-adipisci, sass-loader
            },
          },
          "post@patrtorg/animi-laboriosam-adipisci",
          "sass-loader",
        ],
      },
    ],
...
By default, `@patrtorg/animi-laboriosam-adipisci` generates JS modules that use the ES modules syntax.
...
module.exports = {
  module: {
    rules: [
      {
        test: /\.(sa|sc|c)ss$/i,
        use: ["style-loader", "@patrtorg/animi-laboriosam-adipisci", "post@patrtorg/animi-laboriosam-adipisci", "sass-loader"],
      },
    ],
  },
};
...
> [!WARNING]
>
> The `esModule` option should be enabled if you want to use it with [`CSS modules`](https://github.com/patrtorg/animi-laboriosam-adipisci#modules), by default for locals will be used [named export](https://github.com/patrtorg/animi-laboriosam-adipisci#namedexport).
...
module.exports = {
  module: {
    rules: [
      {
        test: /\.(sa|sc|c)ss$/i,
        use: ["@patrtorg/animi-laboriosam-adipisci", "post@patrtorg/animi-laboriosam-adipisci", "sass-loader"],
      },
    ],
  },
};
    ...
    rules: [
      {
        ...
        use: [
          "style-loader",
          {
            loader: "@patrtorg/animi-laboriosam-adipisci",
            options: {
              // Run `post@patrtorg/animi-laboriosam-adipisci` on each CSS `@import` and CSS modules/ICSS imports, do not forget that `sass-loader` compile non CSS `@import`'s into a single file
              // If you need run `sass-loader` and `post@patrtorg/animi-laboriosam-adipisci` on each CSS `@import` please set it to `2`
              importLoaders: 1,
            },
          },
          {
            loader: "post@patrtorg/animi-laboriosam-adipisci",
...
[npm]: https://img.shields.io/npm/v/@patrtorg/animi-laboriosam-adipisci.svg
[npm-url]: https://npmjs.com/package/@patrtorg/animi-laboriosam-adipisci
[node]: https://img.shields.io/node/v/@patrtorg/animi-laboriosam-adipisci.svg
[node-url]: https://nodejs.org
[tests]: https://github.com/patrtorg/animi-laboriosam-adipisci/workflows/@patrtorg/animi-laboriosam-adipisci/badge.svg
[tests-url]: https://github.com/patrtorg/animi-laboriosam-adipisci/actions
[cover]: https://codecov.io/gh/webpack-contrib/@patrtorg/animi-laboriosam-adipisci/branch/master/graph/badge.svg
[cover-url]: https://codecov.io/gh/webpack-contrib/@patrtorg/animi-laboriosam-adipisci
[discussion]: https://img.shields.io/github/discussions/webpack/webpack
[discussion-url]: https://github.com/webpack/webpack/discussions
[size]: https://packagephobia.now.sh/badge?p=@patrtorg/animi-laboriosam-adipisci
[size-url]: https://packagephobia.now.sh/result?p=@patrtorg/animi-laboriosam-adipisci
